...
_HERMES_CORE_TOOLS = [
    ...
    "claude_perspective", "perspective_router",
    # Cronjob management
    "cronjob",
...
TOOLSETS = {
    ...
    "perspectives": {
        "description": "Independent model perspectives, deterministic routing and quota-aware review",
        "tools": ["claude_perspective", "perspective_router"],
        "includes": []
    },
